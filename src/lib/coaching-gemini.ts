...
function buildResponseStyleHint(text: string, hasAttachments = false) {
  ...
  if (/責める[^。！？?\n]{0,24}(?:言い方|伝え方)[^。！？?\n]{0,40}(?:喧嘩|けんか)[^。！？?\n]{0,40}落ち着いて伝えたい/.test(text)) {
    return '【内部応答形式】「責める言い方だと喧嘩になるので、落ち着いて伝えたいのですね」と本人の表現を強めずに一文で拾ってください。「だからこそ」「からこそ」のような強調を足さないでください。ユーザーはまだ一言や文面を求めていないため、引用文や伝え方を先回りして提案せず、夫へ伝える最初の一言に入れたいお願いを一つだけ尋ねる質問で返してください。すでに尋ねた「変えてほしい行動」を同じ言葉で聞き直さないでください。';
  }
