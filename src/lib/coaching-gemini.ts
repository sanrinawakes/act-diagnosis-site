...
const RESPONSE_SPEED_INSTRUCTION = [
  ...
  '---',
  '## 応答速度と安定性のための追加ルール',
  '- 1回の返答は原則220〜420字に収める。明示的に短く求められた時だけ120〜220字にする。',
  '- 質問が複数ある場合は、すべてを一度に深掘りせず、最初の1つを中心に返す。',
  '- 長い前置き、網羅的な一覧、同じタイプ説明の繰り返しを避ける。ただし通常相談では、受け止めだけ・質問だけ・一文だけで終わらせない。',
  '- 「私の内面を教えてください」のような広い相談では、短く受け止めた後に、根拠を含む1つの見立てと次の小さな質問を返す。',
].join('\n');
