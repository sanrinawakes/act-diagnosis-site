...
export const PREVIOUS_DEFAULT_COACHING_NOTICE_BODY =
...
export const INTERIM_DEFAULT_COACHING_NOTICE_BODY =
  '現在、AIコーチングBotは引き続きご利用いただけます。ただし、まだ一時的に返事が遅くなったり、エラーが表示されたりする場合があります。こちらでも動作を監視しており、検知したエラーは順次、原因を確認して修正しています。十分な確認が終わる前に「改善しました」とご案内してしまい、本当に申し訳ございません。現在確認している応答の遅れとエラーを解消するまで、数日かかる見込みです。その間もAIコーチングBotをお使いいただきながら、修正完了までお待ちくださいますようお願いいたします。';
...
export const DEFAULT_COACHING_NOTICE_SETTINGS = {
  ...
  coaching_notice_body:
    '現在、AIコーチングBotは引き続きご利用いただけます。ただし、まだ一時的に返事が遅くなったり、エラーが表示されたりする場合があります。随時、動作を監視しており、検知したエラーは順次、原因を確認して修正しています。現在確認している応答の遅れとエラーを解消するまで、数日かかる見込みです。その間もAIコーチングBotをお使いいただきながら、修正完了までお待ちくださいますようお願いいたします。',
} satisfies Pick<
  SiteSettings,
